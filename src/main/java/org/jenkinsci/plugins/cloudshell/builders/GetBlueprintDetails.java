...
public class GetBlueprintDetails extends CloudShellBuildStep {

	private final String BpName;

	@DataBoundConstructor
	public GetBlueprintDetails(String bpName) {
	...
	public boolean perform(final AbstractBuild<?, ?> build, final Launcher launcher, final BuildListener listener, CsServer server) {
		...
		String expandedBpName = env.expand(BpName);

		server.GetBluePrintDetails(expandedBpName, listener);
