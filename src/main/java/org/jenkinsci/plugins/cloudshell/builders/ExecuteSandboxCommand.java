...
public class ExecuteSandboxCommand extends CloudShellBuildStep {
	...
	public ExecuteSandboxCommand(String blueprintName, String sandboxDuration, int maxWaitForSandboxAvailability, String params) {
